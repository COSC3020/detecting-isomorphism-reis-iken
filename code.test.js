...
let testCases = [
    {
        graph1: [ [1 , 3], [0 , 2 , 4], [1 , 3], [0 , 2 , 4], [1 , 3], ],
        graph2: [ [4 , 2], [0 , 3], [4 , 2], [0 , 3], [1 , 3], ],
        expectResult: true,
    },
  
    {
        graph1: [ [3 , 5], [2 , 4], [1 , 3 , 5], [0 , 4], [1 , 3], [0 , 2], ],
        graph2: [ [4 , 2], [3 , 5], [1 , 3 , 5], [0 , 4], [1 , 3], [0 , 2], ],
        expectResult: true,
    },
  
    {
        graph1: [ [2 , 4], [1 , 3], [0 , 4], [1 , 3], [0 , 2], ],
        graph2: [ [4 , 2], [3 , 1], [1 , 3], [0 , 4], [0 , 2], ],
        expectResult: true,
    },
  
    {
        graph1: [ [2 , 4], [1 , 3], [0 , 4], [1 , 3], [0 , 2], ],
        graph2: [ [4 , 2], [3 , 1], [1 , 3], [0 , 4], [2 , 0], ],
        expectResult: false,
    },
];
